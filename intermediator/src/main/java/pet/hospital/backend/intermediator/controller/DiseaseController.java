 ...
 * @LastEditTime: 2023-03-30 17:59:20
                                ...
                                @Content(
                                        examples = {
                                            @ExampleObject(
                                                    description = "Success message.",
                                                    value =
                                                            "{\"code\":200,\"data\":{\"diseaseNameContent\":\"test disease 2\",\"diseaseNameCategory\":\"test disease category\",\"diseaseNameId\":4,\"diseaseNamePhoto\":\"disease/diseaseName/d9c280e1-9747-4e9b-a2bc-c1507cf156ad/photo\",\"diseaseNameVideo\":\"disease/diseaseName/d9c280e1-9747-4e9b-a2bc-c1507cf156ad/video\"},\"message\":\"ok\"}")
                                        },
                                        mediaType = MediaType.APPLICATION_JSON_VALUE)),
                @ApiResponse(
                        responseCode = "515",
                                ...
                                @Content(
                                        examples = {
                                            @ExampleObject(
                                                    description = "Success message.",
                                                    value =
                                                            "{\"code\":200,\"data\":{\"diseaseNameContent\":\"test disease3\",\"diseaseNameCategory\":\"test disease category3\",\"diseaseNameId\":3,\"diseaseNamePhoto\":\"disease/diseaseName/e158e5aa-0ade-48f3-89ff-31966ab5a5c0/photo\",\"diseaseNameVideo\":\"disease/diseaseName/e158e5aa-0ade-48f3-89ff-31966ab5a5c0/video\"},\"message\":\"ok\"}")
                                        },
                                        mediaType = MediaType.APPLICATION_JSON_VALUE)),
                @ApiResponse(
                        responseCode = "515",
                                ...
                                @Content(
                                        examples = {
                                            @ExampleObject(
                                                    description = "Success message.",
                                                    value =
                                                            "{\"code\":200,\"data\":{\"diseaseNameContent\":\"22\",\"diseaseNameCategory\":\"22\",\"diseaseNameId\":2,\"diseaseNamePhoto\":\"22\",\"diseaseNameVideo\":\"22\"},\"message\":\"ok\"}")
                                        },
                                        mediaType = MediaType.APPLICATION_JSON_VALUE)),
                @ApiResponse(
                        responseCode = "515",
