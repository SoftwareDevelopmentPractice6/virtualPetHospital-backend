...
public class Constants {
    ...
    public static String authModuleApiPrefix = "login";

    public static String systemModuleApiPrefix = "system";

    public static String diseaseModuleApiPrefix = "disease";

    public static String examModuleApiPrefix = "exam";
