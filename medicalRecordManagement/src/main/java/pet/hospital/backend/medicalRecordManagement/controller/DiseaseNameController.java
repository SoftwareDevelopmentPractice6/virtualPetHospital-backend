...
@RequestMapping(
        value = "/api/medicalRecordManagement/diseaseName",
...
public class DiseaseNameController {
    ...
    public JSONObject getDiseaseName(
        ...
        return diseaseNameService.getDiseaseName(diseaseNameId, URLDecoder.decode(diseaseNameKeyword, Constants.UTF8),
