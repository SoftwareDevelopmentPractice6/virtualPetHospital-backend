...
DELETE FROM STUDENTANSWER WHERE student_answer_id = 1;
...
INSERT INTO STUDENTANSWER (student_answer_id, student_answer_content, student_answer_point, question_in_paper_id, result_id) VALUES (1, "Answer 1", 0, 1, 1);
