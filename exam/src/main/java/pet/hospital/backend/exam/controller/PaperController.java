 ...
 * @LastEditTime: 2023-03-20 15:18:09
            ...
            @Parameter(
                            ...
                            schema =
                                    @Schema(
                                            ...
                                            format = "json-string",
                                            example =
                                                    "{\"paperId\": 2, \"paperName\": \"testPaper2\", \"paperDuration\": \"test hours\", \"paperTotalScore\": \"test score\", \"examId\": 2}"))
                    @RequestParam
                    String newPaperInfo)
            throws UnsupportedEncodingException {
        return paperService.updatePaper(JSON.parseObject(URLDecoder.decode(newPaperInfo, Constants.UTF8)));
    }
