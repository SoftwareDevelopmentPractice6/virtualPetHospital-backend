...
CREATE TABLE IF NOT EXISTS FEATURE(
	func_id INT PRIMARY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS MEDICINE(
	medicine_id INT PRIMARY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS ARCHIVE(
	archive_id INT PRIMARY AUTO_INCREMENT,
	store_time DATE,
...
CREATE TABLE IF NOT EXISTS CHARGE(
	charge_id INT PRIMARY AUTO_INCREMENT,
	item_name VARCHAR(255),
	charge_price FLOAT
);

CREATE TABLE IF NOT EXISTS EXAMINE(
	examine_id INT PRIMARY AUTO_INCREMENT,
	examine_name VARCHAR(255),
	examine_price FLOAT
);

CREATE TABLE IF NOT EXISTS ADMISSION(
	admission_id INT PRIMARY AUTO_INCREMENT,
